...
class MainSettings:
    ...
    custom_frameres = False #choose if the frames should be rendered at the same resolution as they are in the video or if you'd like to change frame resolution in frame_res [default: False]
